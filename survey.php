...
<head>
    ...
    <meta name="description" content="Feadback Survey form  by Monir.">
    <meta name="author" content="Monir">
    <title>Feedback | Satisfaction Survey form </title>
...
<?php
						...
						$subject = "Survey from feedback";
						$headers = 'From: Survey from feedback <noreply@satisfyc.com>' . "\r\n" . 'Reply-To: <noreply@satisfyc.com>';
						$message = "DETAILS\n";
